...
DIRECTORY = '/home/hcarbono/Documentos/super_peer_TET/files_peer_2/'
...
def login():
    try:
        response = requests.post(f"http://localhost:5000/register_peer", json={"peer_address": "localhost:5002"})
